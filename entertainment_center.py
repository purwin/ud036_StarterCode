...
bottle_rocket = Movie("Bottle Rocket",
                      ...
                      "http://rushmoreacademy.com/wp-content/uploads/2011/07/BottleRocketOnline1.jpeg",  # NOQA
                      "https://www.youtube.com/watch?v=hspUSez-rYY")

il_posto = Movie("Il Posto",
                 "\"A very young college graduate attempts to obtain a"
                 " position with a large corporation.\"",
                 "https://media-cache.cinematerial.com/p/500x/0zkokvl2/il-posto-french-movie-poster.jpg",  # NOQA
...
true_stories = Movie("True Stories",
                     "\"A small but growing Texas town [...] celebrates its"
                     "sesquicentennial and converge on a local parade and"
                     " talent show.\"",
                     "https://fiu-assets-2-syitaetz61hl2sa.stackpathdns.com/static/use-media-items/31/30476/full-736x1120/567022c9/53d3394034a8c13d99d755c81879c4ea.jpeg?resolution=0",  # NOQA  # NOQA
                     "https://www.youtube.com/watch?v=mhRgCsQf3CU")

la_jetee = Movie("La Jetée",
                 "\"The story of a man forced to explore his memories in the"
...
big_trouble_in_little_china = Movie("Big Trouble in Little China",
                                    ...
                                    " into a centuries-old mystical battle in"
                                    " Chinatown.\"",
                                    "https://alchetron.com/cdn/Big-Trouble-in-Little-China-images-102f975a-a9d2-4ea4-a7e8-244cc437116.jpg",  # NOQA
                                    "https://www.youtube.com/watch?v=592EiTD2Hgo")  # NOQA

# Store movie class instances in a list.
movies = [bottle_rocket, il_posto, dr_strangelove,
          true_stories, la_jetee, big_trouble_in_little_china]
